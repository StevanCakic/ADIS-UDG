...
date_difference_years = relativedelta(now, moon_landing_datetime)
print(date_difference_years.years)
print(date_difference_years.months)
print(date_difference_years.days)